...
@Composable
fun NewSettingsAIProviderScreen(
    onBack: () -> Unit,
    onOpenHelp: () -> Unit
) {
    ...
    NewSettingsScaffold(
        title = stringResource(id = R.string.settings_configure_provider),
        onBack = onBack,
        onHelp = onOpenHelp,
        ...
        testResult?.let { result ->
            ...
            Card(
                ...
                colors = CardDefaults.cardColors(
                    containerColor = if (testSuccess) MaterialTheme.colorScheme.primaryContainer
                ...
                Row(
                    ...
                    Text(
                        text = if (testSuccess) stringResource(id = R.string.ai_settings_connection_success) else result,
                        style = MaterialTheme.typography.bodyMedium,
                        color = if (testSuccess) MaterialTheme.colorScheme.onPrimaryContainer
