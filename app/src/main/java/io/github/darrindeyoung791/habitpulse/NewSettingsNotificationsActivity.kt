...
import io.github.darrindeyoung791.habitpulse.ui.screens.settings.NewSettingsNotificationsScreen
import io.github.darrindeyoung791.habitpulse.ui.theme.HabitPulseTheme

class NewSettingsNotificationsActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContent {
            HabitPulseTheme {
                NewSettingsNotificationsContent()
            }
        }
    }
}
...
@Composable
private fun NewSettingsNotificationsContent() {
