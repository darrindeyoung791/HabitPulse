...
import io.github.darrindeyoung791.habitpulse.ui.screens.settings.SettingsNotificationsScreen
import io.github.darrindeyoung791.habitpulse.ui.theme.HabitPulseTheme

class SettingsNotificationsActivity : ComponentActivity() {
...
private fun SettingsNotificationsContent() {
    ...
    SettingsNotificationsScreen(
        ...
        onOpenHelp = onHelp,
        onNavigateTemplate = {
            context.startActivity(Intent(context, SettingsTemplateActivity::class.java))
        }
    )
}
